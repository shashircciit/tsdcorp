#tsd-corp
************************
I used the mentioned APi and rendered the list. User can add any URL and after submit button click the data will be added in the list and  onclick of trash icon data will be deleted.
